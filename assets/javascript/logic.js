...
// 1. Link to Firebase
var config = {
    apiKey: "AIzaSyAuVZlzFMKtnewPzhqwe9sYQ3BCmchZ1Ok",
    authDomain: "trainscheduler-3f809.firebaseapp.com",
    databaseURL: "https://trainscheduler-3f809.firebaseio.com",
    projectId: "trainscheduler-3f809",
    storageBucket: "",
    messagingSenderId: "151156749351"
  };
...
$("#addTrainBtn").on("click", function(){
	...
	var firstTrainUnix = moment($("#firstTrainInput").val().trim(), "HH:mm").subtract(1, "years").format("X");
